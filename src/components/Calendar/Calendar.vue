    ...
    <section class="calendar-container">
      ...
      <form>
        <div class="social-selected">
          <svg
            @click="selectSocial('wh')"
            :class="selectedSocial == 'wh' ? 'active' : ''"
          ...
          <svg
            @click="selectSocial('tel')"
            :class="selectedSocial == 'tel' ? 'active' : ''"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            viewBox="0 0 24 24"
          ...
          <svg
            @click="selectSocial('vib')"
            :class="selectedSocial == 'vib' ? 'active' : ''"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            viewBox="0 0 24 24"
